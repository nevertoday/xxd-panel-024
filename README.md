...
我做 **Panel 024**，就是想解决这个别扭。它不是给照片硬套模板，而是先认出照片里真正不能丢的东西，再把它翻译成：**让真实物象穿越一扇浅色几何情绪窗口**。
...
<table>
  ...
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 024 样张 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 024 样张 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 024 样张 8"></td>
  </tr>
</table>
